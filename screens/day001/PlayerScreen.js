    ...
    <View style={{ flex: 1, backgroundColor: "#1a1b1f" }}>
      ...
      <View
        style={{
          flex: 1,
          backgroundColor: "red",
          borderBottomColor: "#848588",
          borderBottomWidth: 2,
        }}
      >
        <Image
          source={require("./imgs/big.jpg")}
          style={{ width: 395, height: 335 }}
        />
        <Text
          style={{
            fontSize: 40,
